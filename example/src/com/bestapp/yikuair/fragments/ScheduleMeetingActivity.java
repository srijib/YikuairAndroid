...
public class ScheduleMeetingActivity extends Activity {
	private int currentIndex = MessageInfo.MEETING;
	...
	public static ScheduleMeetingActivity instance = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		instance = this;
		setContentView(R.layout.schedule_edit_meeting);
	...
	public void sendSchedule(boolean isGroupChat) {
		...
		Intent intent1 = new Intent(ScheduleMeetingActivity.this,
				ChatActivity.class);
	...
	private void addMember() {
		...
		intent.setClass(ScheduleMeetingActivity.this,
		...
		public void onClick(View v) {
			...
			case R.id.tv_finish_right:
				try {
					...
					if (client == null)
						client = new ClientSocket(ScheduleMeetingActivity.this);
