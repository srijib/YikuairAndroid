...
import com.bestapp.yikuair.fragments.CropImageActivity;
...
public class CropImage {
	...
	public static final File FILE_LOCAL = new File(FILE_SDCARD, "yikuair");
	...
	public String saveToLocal(Bitmap bm) {
		String path = FILE_LOCAL + "photo.jpg";
		try {
